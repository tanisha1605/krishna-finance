...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { text: "Blog", path: "/blog" },
    { text: "Life@KrishnaFinance", path: "/life-at-krishna-finance" }, // <-- Updated path here
      ...
      >
        ...
        <motion.div className={styles.mainGrid} variants={containerVariants}>
          ...
          <motion.div variants={itemVariants} className={styles.infoCol}>
            ...
            <motion.div variants={textVariants} className={styles.iconRow}>
              ...
              <p>
                609 - SHREEJI Business, opposite hanspura residency, Hanspura,
            ...
            <div className={styles.emailRow}>
              ...
              <motion.div variants={textVariants} className={styles.iconRow}>
                ...
                <a href="mailto:support@KrishnaFinance.com">
                  support@KrishnaFinance.com
                </a>
              </motion.div>
            </div>
          </motion.div>
        ...
        <motion.div className={styles.disclaimerBox} variants={itemVariants}>
          <motion.p variants={textVariants}>
            <span>Disclaimer:</span> We provide consultancy services in areas
            such as pitch deck preparation, financial reporting, business
            incorporation...
          </motion.p>
          <motion.p variants={textVariants} className="mt-4">
            <span>Note:</span> Payments for services are only accepted in the
            name of Krishna Finance...
          </motion.p>
        </motion.div>
